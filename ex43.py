...
class Map(object):
    ...
    def __init__(self, start_scene):
        self.start_scene = start_scene # string

    def next_scene(self, scene_name):
        return Map.scenes.get(scene_name) # dict.get(key) return the key's value
